...
#line 1 "6b-idopkey.y" /* yacc.c:339  */
 int yywrap();
void yyerror();
int yyparse();
#line 5 "6b-idopkey.y" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "ID", "KEY", "OP", "$accept", "input", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 12 "6b-idopkey.y" /* yacc.c:1646  */
    {id++;}
...
#line 13 "6b-idopkey.y" /* yacc.c:1906  */
